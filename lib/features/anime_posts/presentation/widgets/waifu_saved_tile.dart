...
class WaifuSavedTile extends StatelessWidget {
  const WaifuSavedTile({super.key, this.waifu});
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: GestureDetector(
              onTap: () {
                context.read<LocalWaifusBloc>().add(RemoveWaifusEvent(waifu!));
                ScaffoldMessenger.of(context)
                  ..hideCurrentSnackBar()
                  ..showSnackBar(
                    SnackBar(
                      backgroundColor: theme.colorScheme.error,
                      content: const Text('Waifu removed successfully.'),
                    ),
                  );
              },
              child: ClipRRect(
